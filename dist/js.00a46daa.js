...
var menuIcon = select('.nav-btn');
var introName = select('.intro-name');
var introInfo = select('.intro-info');
var introImage1 = select('.intro-image-one');
var introImage2 = select('.intro-image-two');
